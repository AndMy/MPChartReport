...
public class ExcelPanelAdapter extends BaseExcelPanelAdapter<RowTitle, ColTitle, Cell> {

    private Context context;
    private View.OnClickListener blockListener;
    private String topLeftDec ;

    public ExcelPanelAdapter(Context context, View.OnClickListener blockListener,String topLeftDec) {
        super(context);
    ...
    public View onCreateTopLeftView() {
        View view= LayoutInflater.from(context).inflate(R.layout.room_status_left_top_cell, null);
        TextView textView = view.findViewById(R.id.channel_name);
        textView.setText(topLeftDec==null?"日期":topLeftDec);
        return view;
    }
}
